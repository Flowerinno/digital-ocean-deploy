...
3. Enable Public ipv6
4. Auth via SSH key, add your id_rsa.pub key
   In terminal `cat ~/.ssh/id_rsa.pub`
5. Hostname -> your domain example.au !!important!!
6. You can create your database while creating the droplet or later in the database section (managed DB)
...
10. It could take some time for secured https url to work, be patient.
